...
#import "HJMotherChangeCell.h"

@implementation HJMotherChangeCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _subtitle.text = @"进入孕24周，子宫现在约在肚脐上3.8-5.1厘米的位置，从趾骨联合量起，约有24厘米。";
